...
import threading
from trainer import ZenTrainer

class ZenGUI:
    def __init__(self):
        self.trainer = ZenTrainer()
        self.root = tk.Tk()
        self.root.title("Hades II Trainer Z 1.0.0")
    ...
    def build_ui(self):
        header = tk.Label(self.root, text="HADES II TRAINER Z", bg="#1a1a2e", fg="#c43549",
